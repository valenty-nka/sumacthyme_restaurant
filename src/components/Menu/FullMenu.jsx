...
const menuData = {
  "Mezzes & Salads": [
    ...
    { name: "Çoban 🌾🌱", price: "$13.99", desc: "A fresh mix of tomatoes, cucumbers, and onions, tossed in our signature S&T dressing" },
    { name: "Hummus 🌾🌱", price: "$8.99", desc: "Blended creamy chickpeas, garlic, tahini, extra virgin olive oil" },
    { name: "Potato Salad 🌾🌱", price: "$10.99", desc: "A classic homemade potato salad with tender boiled potatoes, eggs, celery and creamy dressing" },
  ...
  "Hot Starters":[
    ...
    { name: "Turkish Stuffed Meatballs “İÇLİ KOFTE”", price: "$14.99", desc: "Soft bulgur shells filled with seasoned ground beef, topped with aromatic oil" },
  ...
  "Plates": [
    ...
    { name: "Turkish “KÖFTE”", price: "$23.99", desc: "Seared beef patties, perfectly seasoned and served with sides" },
    { name: "S&T Burger", price: "$20.99", desc: "Double cheese burger with our signature S&T sauce, served with french fries" },
    { name: "Mixed Grill Kebab (for 4)", price: "$84.99", desc: "Includes 1 skewer of kebab, 1 lamb bite shish, 1 shish tavuk, 2 grilled chicken thighs, 2 grilled köfte, served with sides" },
  ],
  "Handhelds": [
    ...
    { name: "Chicken Baguette", price: "$15.99", desc: "Sautéed chicken with crispy fried potatoes and garlic sauce, served with warm baguette" },
    { name: "Turkish Chicken “TANTUNİ”", price: "$15.99", desc: "Thinly sliced chicken with herbed onions and tomatoes, wrapped in flatbread" },
  ...
  "Desserts": [
    ...
    { name: "Baked Rice Pudding 'Firinda Sütlaç'", price: "$10.99", desc: "Creamy baked rice pudding with a lightly caramelized top, delicately flavoured and served chilled" },
